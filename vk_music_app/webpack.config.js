...
const ENV = args.e || args.env || args.enviroment || 'dev';
...
if (!IS_LOC) {
  ...
  config.module.loaders.push({
    test: /\.scss$/,
    loader: ExtractTextPlugin.extract('style', 'css?modules&importLoaders=1&localIndentName=[name]__[local]__[hash:base64:5]!postcss-loader!resolve-url!sass')
  });
  config.module.loaders.push({
    test: /\.css$/,
